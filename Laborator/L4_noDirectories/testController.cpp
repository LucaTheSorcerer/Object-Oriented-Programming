...
void testControllerConstructor() {
    ...
    {
        ControllerFruit::Controller fruitController("../testDataBase1");
        assert(fruitController.getAllFruits()->empty());
    }
    //Test valid Data Base
    {
        ControllerFruit::Controller fruitController("../testDataBase2");
...
void testAddFruit() {
    ControllerFruit::Controller controller("../testDataBase1");
...
void testDeleteFruit() {
    ControllerFruit::Controller fc("../testDataBase1");
